...
document.addEventListener(RENDER_EVENT, () => {
  ...
  const finishedBook = document.getElementById("haveRead");
...
document.addEventListener(SAVED_EVENT, () => {
  ...
  elementCustomAlert.innerText = "BOOK SUCCESSFULLY SAVED!";
...
document.addEventListener(MOVED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert");
  elementCustomAlert.innerText = "BOOK SUCCESSFULLY MOVED!";
...
document.addEventListener(DELETED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert");
  elementCustomAlert.innerText = "BOOK SUCCESSFULLY ERASED!";
...
const addBook = () => {
  ...
  const bookHasFinished = document.getElementById("readed");
  let bookStatus;
...
const makeBookElement = (bookObject) => {
  ...
  if (bookObject.isComplete) {
    ...
    deleteBtn.classList.add("erase-btn");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const simpanForm = document.getElementById("bookForm");
